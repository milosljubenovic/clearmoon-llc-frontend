                        ...
                        <div class="header-logo" style="width: 123px; height: 33px;">
                            <a href="{{ route('demo.business.index') }}">
                                ...
                                <img src="{{ asset('public/assets/images/logo/' . $settings->general->logo) }}"
                                    class="img-fluid" alt="" style="top: 0px; height: 50px;">
                                @endif
                            </a>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li><a href="{{ route('demo.business.blog') }}"
                                                class="nav-link {{ Route::is('demo.business.blog') ? 'active current-page-active' : '' }}">Blog</a>
                                        </li>
