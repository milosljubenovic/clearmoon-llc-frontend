        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="mb-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1400" style="animation-delay: 1400ms;">
                    We are strong individuals, easily integratable within large teams, and have a strong sense of responsibility.
                    We are always ready to take on new challenges and learn new technologies.
                    <br>
                ...
                <div class="accordion custom-accordion-style-1 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1600" id="accordion1" style="animation-delay: 1600ms;">
                    <div class="card card-default">
                        ...
                        <div id="collapse1One" class="collapse" aria-labelledby="collapse1HeadingOne" data-bs-parent="#accordion1">
                            <div class="card-body">
                                <p class="mb-0">
                                    We offer easiest solutions for your IT needs and so clients get tense free...
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="card card-default">
                        ...
                        <div id="collapse1Two" class="collapse" aria-labelledby="collapse1HeadingTwo" data-bs-parent="#accordion1">
                            <div class="card-body">
                                <p class="mb-0">
                                    It Depends. We have different payment plans for different services...
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card card-default">
                        <div class="card-header" id="collapse2HeadingTwo">
                            <h4 class="card-title m-0">
                                <a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse2Two" aria-expanded="false" aria-controls="collapse2Two">
                                    3 - Do we have strong background?
                                </a>
                            </h4>
                        </div>
                        <div id="collapse2Two" class="collapse" aria-labelledby="collapse2HeadingTwo" data-bs-parent="#accordion2">
                            <div class="card-body">
                                <p class="mb-0">
                                    Yes we does. We are a team of professionals with strong background...
                                </p>
                            </div>
                        </div>
